...
- **[Snapshot App Data](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/docs/SNAPSHOT_APP_DATA.md)**: Attach application metadata to automatic and manual session snapshots
