...
class ToolWatcher:
    ...
    def start(self) -> None:
        ...
        # Serializes access to the shared class state below: without this, two threads can
        # both see _observer_started as False and both call Observer.start().
        with ToolWatcher._lock:
