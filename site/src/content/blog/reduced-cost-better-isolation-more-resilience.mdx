...
When we scale agents internally at AWS, we run into the same issues. Today we're shipping three updates in Strands that solve these problems: better context management in the [SDK](https://github.com/strands-agents/harness-sdk), a new isolated execution environment with [Strands Shell](https://github.com/strands-agents/shell), and chaos testing and red teaming in [Strands Evals](https://github.com/strands-agents/evals).
