...
Another approach is to define rigid workflows using graph and multi-agent abstractions, like the [graph](https://strandsagents.com/docs/user-guide/sdk/multi-agent/graph/) and [workflow](https://strandsagents.com/docs/user-guide/sdk/multi-agent/workflow/) patterns in Strands. You decompose the agent's task into discrete nodes with defined edges between them, applying what we know from deterministic programming (if statements, loops, conditional branches) to agent behavior.
...
[Strands steering](https://strandsagents.com/docs/user-guide/sdk/agents/interventions/steering/) takes a different approach. Instead of front-loading all instructions into a monolithic prompt or constraining the agent to a rigid workflow, steering provides **just-in-time guidance** to the agent at the moments that matter.
...
Steering handlers can intercept agent behavior at two points via [hooks](https://strandsagents.com/docs/user-guide/sdk/agents/hooks/):
...
- Read the [steering documentation](https://strandsagents.com/docs/user-guide/sdk/agents/interventions/steering/)
