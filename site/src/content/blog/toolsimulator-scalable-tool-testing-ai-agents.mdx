...
- Read the [Strands Evals documentation](https://strandsagents.com/latest/user-guide/sdk/observability-evaluation/evals/) to explore all configuration options, including advanced state management and custom evaluators.
