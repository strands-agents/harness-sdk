...
The [quickstart](https://strandsagents.com/) gets you to a running agent in a few minutes, and the [tools guide](https://strandsagents.com/latest/documentation/docs/user-guide/sdk/tools/) covers everything the `@tool` decorator can do. If you build something, tell us in [the Discord](https://discord.gg/strands) or open a discussion on [GitHub](https://github.com/strands-agents/harness-sdk/discussions). We want to see the boring task you never have to think about again.
