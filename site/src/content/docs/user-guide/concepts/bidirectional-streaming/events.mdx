...
from strands.experimental.bidi import AudioDelta
...
Send a complete encoded image with `ImageBlock`. A live camera feed sends successive
images, each containing a complete frame.
