...
description: Run an adversarial red-team experiment against a Strands agent end to end, generating attack cases, running a strategy, and reading which attacks breached.
