...
You build a graph by defining its nodes, the edges between them, and its entry points. For the full list of node and edge fields, `GraphBuilder` methods, and TypeScript constructor options, see [Graph components](./graph-components.md).

<Tabs>
<Tab label="Python">

To create a [`Graph`](@api/python/strands.multiagent.graph#Graph), use the [`GraphBuilder`](@api/python/strands.multiagent.graph#GraphBuilder) to define nodes, edges, and entry points:
...
```typescript
--8<-- "user-guide/sdk/multi-agent/graph.ts:create_graph"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/multi-agent/graph.ts:conditional_edge"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/multi-agent/graph.ts:nested"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/multi-agent/graph.ts:remote_agents"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/multi-agent/graph.ts:custom_node"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/multi-agent/graph.ts:multimodal"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/multi-agent/graph.ts:streaming"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/multi-agent/graph.ts:results"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/multi-agent/graph.ts:topology_sequential"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/multi-agent/graph.ts:topology_parallel"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/multi-agent/graph.ts:topology_branching"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/multi-agent/graph.ts:topology_feedback"
```
</Tab>
</Tabs>
...
**Session resume**: Dispatched nodes remain in the checkpoint's pending work while waiting
for a concurrency slot. A restart resumes those nodes before scheduling dependent nodes.
