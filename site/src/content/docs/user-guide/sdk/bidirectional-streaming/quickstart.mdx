...
from strands.experimental.bidi.io import AudioIO
from strands.experimental.bidi.models import BedrockNovaSonicModel
from strands.experimental.bidi.types import BidiResponseInterruptEvent
...
Over open speakers, the agent's own playback can feed back into the microphone and
interrupt it. Either use a headset, or enable microphone audio processing to cancel
the echo:
