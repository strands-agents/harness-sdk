 ...
 * [Traces](./traces.md)
 * [Logs](./logs.md)
 * [Evaluation](../../evals-sdk/quickstart)


## Telemetry Primitives

Building observable agents starts with monitoring the right telemetry. Agents use the same fundamental building blocks as traditional software (**traces**, **metrics**, and **logs**), but applying them to agents takes special consideration. You capture standard application telemetry alongside AI-specific signals like model interactions, reasoning steps, and tool usage.
