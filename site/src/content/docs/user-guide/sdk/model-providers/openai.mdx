...
[OpenAI](https://platform.openai.com/docs/overview) is an AI research and deployment company that provides a range of language models. The Strands Agents SDK implements an OpenAI provider, letting you run agents against any OpenAI or OpenAI-compatible model.
...
```typescript
--8<-- "user-guide/sdk/model-providers/openai_imports.ts:basic_usage_imports"

--8<-- "user-guide/sdk/model-providers/openai.ts:basic_usage"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/openai.ts:custom_server"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/openai_imports.ts:structured_output_imports"

--8<-- "user-guide/sdk/model-providers/openai.ts:structured_output"
```
</Tab>
</Tabs>
...
You can pass your own OpenAI client to the OpenAIModel for Strands Agents to use directly. You are responsible for handling the lifecycle (e.g., closing) of the client.
...
```typescript
--8<-- "user-guide/sdk/model-providers/openai_imports.ts:custom_client_imports"

--8<-- "user-guide/sdk/model-providers/openai.ts:custom_client"
```
</Tab>
</Tabs>
...
- [Migrate from OpenAI to Strands](../../migrate/openai.md) — move a hand-written `chat.completions` loop or an OpenAI Agents SDK app to Strands
