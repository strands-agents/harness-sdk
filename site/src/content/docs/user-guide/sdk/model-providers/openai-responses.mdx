...
```typescript
--8<-- "user-guide/sdk/model-providers/openai-responses_imports.ts:basic_usage_imports"

--8<-- "user-guide/sdk/model-providers/openai-responses.ts:basic_usage"
```
...
```typescript
--8<-- "user-guide/sdk/model-providers/openai-responses.ts:web_search"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/openai-responses.ts:file_search"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/openai-responses.ts:code_interpreter"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/openai-responses.ts:remote_mcp"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/openai-responses.ts:shell"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/openai-responses.ts:stateful"
```
</Tab>
</Tabs>
...
- [Migrate from OpenAI to Strands](../../migrate/openai.md) — move a hand-written OpenAI loop or an OpenAI Agents SDK app to Strands
