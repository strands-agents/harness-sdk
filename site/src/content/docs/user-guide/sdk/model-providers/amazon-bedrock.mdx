...
```typescript
--8<-- "user-guide/sdk/model-providers/amazon-bedrock_imports.ts:custom_credentials_imports"

--8<-- "user-guide/sdk/model-providers/amazon-bedrock.ts:custom_credentials"
```
...
A basic `Agent` uses the [`BedrockModel`](@api/python/strands.models.bedrock) provider with [Claude Sonnet 4.6](https://www.anthropic.com/claude/sonnet) by default:
...
A basic `Agent` uses the [`BedrockModel`](@api/typescript/BedrockModel) provider with [Claude Sonnet 4.6](https://www.anthropic.com/claude/sonnet) by default:

```typescript
--8<-- "user-guide/sdk/model-providers/amazon-bedrock_imports.ts:basic_default_imports"

--8<-- "user-guide/sdk/model-providers/amazon-bedrock.ts:basic_default"
```
...
--8<-- "user-guide/sdk/model-providers/amazon-bedrock.ts:basic_model_id"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/amazon-bedrock.ts:basic_model_instance"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/amazon-bedrock.ts:configuration"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/amazon-bedrock_imports.ts:request_timeout_imports"

--8<-- "user-guide/sdk/model-providers/amazon-bedrock.ts:request_timeout"
```
...
```typescript
--8<-- "user-guide/sdk/model-providers/amazon-bedrock.ts:request_timeout_handler_options"
```
...
```typescript
--8<-- "user-guide/sdk/model-providers/amazon-bedrock.ts:streaming"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/amazon-bedrock.ts:multimodal_full"
```
</Tab>
</Tabs>

For the full list of input types, see the [API Reference](@api/python/strands.types.content).
...
```typescript
--8<-- "user-guide/sdk/model-providers/amazon-bedrock.ts:s3_location"
```
</Tab>
</Tabs>
...
Configure a [guardrail](https://docs.aws.amazon.com/bedrock/latest/userguide/guardrails.html) on your [`BedrockModel`](@api/python/strands.models.bedrock) to keep model output within your policies:
...
Configure a [guardrail](https://docs.aws.amazon.com/bedrock/latest/userguide/guardrails.html) on your [`BedrockModel`](@api/typescript/BedrockModel) to keep model output within your policies:

```typescript
--8<-- "user-guide/sdk/model-providers/amazon-bedrock.ts:guardrails"
```
...
Strands caches system prompts, tools, and messages on Bedrock to reduce token
usage and latency. See [Bedrock prompt caching](./amazon-bedrock-prompt-caching.md)
for automatic and manual cache point placement, per-model token minimums, and
cache metrics.
...
```typescript
--8<-- "user-guide/sdk/model-providers/amazon-bedrock.ts:update_config"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/amazon-bedrock_imports.ts:tool_update_config_imports"

--8<-- "user-guide/sdk/model-providers/amazon-bedrock.ts:tool_update_config"
```
</Tab>
</Tabs>
...
Enable reasoning on your [`BedrockModel`](@api/python/strands.models.bedrock):
...
Enable reasoning on your [`BedrockModel`](@api/typescript/BedrockModel):

```typescript
--8<-- "user-guide/sdk/model-providers/amazon-bedrock.ts:reasoning"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/amazon-bedrock_imports.ts:structured_output_imports"

--8<-- "user-guide/sdk/model-providers/amazon-bedrock.ts:structured_output"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/amazon-bedrock_imports.ts:mantle_config_imports"

--8<-- "user-guide/sdk/model-providers/amazon-bedrock.ts:mantle_config"
```
...
```typescript
--8<-- "user-guide/sdk/model-providers/amazon-bedrock_imports.ts:bedrock_mantle_imports"

--8<-- "user-guide/sdk/model-providers/amazon-bedrock.ts:bedrock_mantle"
```
</Tab>
</Tabs>
