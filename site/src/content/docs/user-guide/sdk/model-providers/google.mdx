...
[Google Gemini](https://ai.google.dev/api) is Google's family of multimodal large language models. The Strands Agents SDK implements a Google/Gemini provider, letting you run agents against the Gemini models available through Google's AI API.
...
```typescript
--8<-- "user-guide/sdk/model-providers/google_imports.ts:basic_usage_imports"

--8<-- "user-guide/sdk/model-providers/google.ts:basic_usage"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/google.ts:params_example"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/google.ts:builtin_tools"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/google.ts:error_handling"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/google_imports.ts:structured_output_imports"

--8<-- "user-guide/sdk/model-providers/google.ts:structured_output"
```
</Tab>
</Tabs>
...
You can pass your own Gemini client to the GeminiModel for Strands Agents to use directly. You are responsible for handling the lifecycle (e.g., closing) of the client.
...
```typescript
--8<-- "user-guide/sdk/model-providers/google_imports.ts:custom_client_imports"

--8<-- "user-guide/sdk/model-providers/google.ts:custom_client"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/google_imports.ts:image_imports"

--8<-- "user-guide/sdk/model-providers/google.ts:image_input"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/google_imports.ts:document_imports"

--8<-- "user-guide/sdk/model-providers/google.ts:document_input"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/model-providers/google_imports.ts:video_imports"

--8<-- "user-guide/sdk/model-providers/google.ts:video_input"
```
</Tab>
</Tabs>
