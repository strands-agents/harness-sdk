...
[llama.cpp](https://github.com/ggml-org/llama.cpp) is a C++ inference engine for running large language models locally. The Strands Agents SDK implements a llama.cpp provider, letting you run agents against any llama.cpp server with quantized models.
