...
[Mistral AI](https://mistral.ai/) is a research lab that builds open source large language models. Its models cover multilingual text, code generation, math, and reasoning, and are offered in both premier and free tiers.
