...
description: 'How the Strands Harness SDK versions releases: semantic versioning guarantees, experimental feature policies, and deprecation timelines explained.'
sidebar:
...
The Strands Harness SDK is an open-source project that follows semantic versioning to give predictable, stable releases. This page explains the versioning approach, experimental features, and deprecation policies that guide SDK development.
...
The AI ecosystem evolves rapidly, with new standards and protocols emerging regularly. The SDK integrates with several that are still changing:
...
* **Major releases**: With advance notice and detailed migration guides
...
* **Release Notes**: Check GitHub Releases for detailed changelogs
    * [Strands Harness SDK](https://github.com/strands-agents/harness-sdk/releases)
...
* **GitHub Discussions**: Join conversations about proposed changes
    * [Strands Harness SDK Discussions](https://github.com/strands-agents/harness-sdk/discussions)
...
The Strands Harness SDK is an open-source project that welcomes community contributions. Here's how to participate:
...
* **Report Issues**: Submit bug reports or feature requests via GitHub Issues
    * [Strands Harness SDK Issues](https://github.com/strands-agents/harness-sdk/issues)
