...
```typescript
--8<-- "user-guide/sdk/agents/retry-strategies_imports.ts:default_strategy_imports"

--8<-- "user-guide/sdk/agents/retry-strategies.ts:default_strategy"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/agents/retry-strategies_imports.ts:custom_backoff_imports"

--8<-- "user-guide/sdk/agents/retry-strategies.ts:custom_backoff"
```
...
```typescript
--8<-- "user-guide/sdk/agents/retry-strategies_imports.ts:disable_imports"

--8<-- "user-guide/sdk/agents/retry-strategies.ts:disable"
```
</Tab>
</Tabs>
...
For more control over retry decisions, such as validating model responses or handling additional error types, you have two options:
...
```typescript
--8<-- "user-guide/sdk/agents/retry-strategies_imports.ts:custom_subclass_imports"

--8<-- "user-guide/sdk/agents/retry-strategies.ts:custom_subclass"
```
...
```typescript
--8<-- "user-guide/sdk/agents/retry-strategies_imports.ts:hook_retry_imports"

--8<-- "user-guide/sdk/agents/retry-strategies.ts:hook_retry"
```
</Tab>
</Tabs>
