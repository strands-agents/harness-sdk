...
```python
--8<-- "user-guide/sdk/agents/interventions/cedar-authorization.py:basic_example"
```
</Tab>
<Tab label="TypeScript">

```typescript
--8<-- "user-guide/sdk/agents/interventions/cedar-authorization_imports.ts:basic_example_imports"

--8<-- "user-guide/sdk/agents/interventions/cedar-authorization.ts:basic_example"
```
</Tab>
</Tabs>
...
```python
--8<-- "user-guide/sdk/agents/interventions/cedar-authorization.py:role_based"
```
</Tab>
<Tab label="TypeScript">

```typescript
--8<-- "user-guide/sdk/agents/interventions/cedar-authorization_imports.ts:role_based_imports"

--8<-- "user-guide/sdk/agents/interventions/cedar-authorization.ts:role_based"
```
</Tab>
</Tabs>
...
```python
--8<-- "user-guide/sdk/agents/interventions/cedar-authorization.py:rate_limit"
```
</Tab>
<Tab label="TypeScript">

```typescript
--8<-- "user-guide/sdk/agents/interventions/cedar-authorization_imports.ts:rate_limit_imports"

--8<-- "user-guide/sdk/agents/interventions/cedar-authorization.ts:rate_limit"
```
</Tab>
</Tabs>
...
```python
--8<-- "user-guide/sdk/agents/interventions/cedar-authorization.py:schema_validation"
```
</Tab>
<Tab label="TypeScript">

```typescript
--8<-- "user-guide/sdk/agents/interventions/cedar-authorization_imports.ts:schema_validation_imports"

--8<-- "user-guide/sdk/agents/interventions/cedar-authorization.ts:schema_validation"
```
</Tab>
</Tabs>
...
```python
--8<-- "user-guide/sdk/agents/interventions/cedar-authorization.py:namespace"
```
</Tab>
<Tab label="TypeScript">

```typescript
--8<-- "user-guide/sdk/agents/interventions/cedar-authorization_imports.ts:namespace_imports"

--8<-- "user-guide/sdk/agents/interventions/cedar-authorization.ts:namespace"
```
</Tab>
</Tabs>
...
```python
--8<-- "user-guide/sdk/agents/interventions/cedar-authorization.py:env_gating"
```
</Tab>
<Tab label="TypeScript">

```typescript
--8<-- "user-guide/sdk/agents/interventions/cedar-authorization_imports.ts:env_gating_imports"

--8<-- "user-guide/sdk/agents/interventions/cedar-authorization.ts:env_gating"
```
</Tab>
</Tabs>

Permit an allowlist of environments rather than denying `"production"`. An allowlist stays fail-closed: when `environment` is missing from <Syntax py="invocation_state" ts="invocationState" />, the enricher's fallback value falls outside the permitted set and the call is denied. A rule that denies `"production"` instead would permit that call, along with any spelling the rule doesn't match exactly: `"Production"`, `"prod"`, `"prod-us-east-1"`.
...
```python
--8<-- "user-guide/sdk/agents/interventions/cedar-authorization.py:file_policies"
```
</Tab>
<Tab label="TypeScript">

```typescript
--8<-- "user-guide/sdk/agents/interventions/cedar-authorization_imports.ts:file_policies_imports"

--8<-- "user-guide/sdk/agents/interventions/cedar-authorization.ts:file_policies"
```
</Tab>
</Tabs>
...
```python
--8<-- "user-guide/sdk/agents/interventions/cedar-authorization.py:hot_reload"
```
</Tab>
<Tab label="TypeScript">

```typescript
--8<-- "user-guide/sdk/agents/interventions/cedar-authorization_imports.ts:hot_reload_imports"

--8<-- "user-guide/sdk/agents/interventions/cedar-authorization.ts:hot_reload"
```
</Tab>
</Tabs>
