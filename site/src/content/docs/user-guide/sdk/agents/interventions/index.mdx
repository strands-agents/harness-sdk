...
```python
--8<-- "user-guide/sdk/agents/interventions/interventions.py:basic_usage"
```
</Tab>
<Tab label="TypeScript">

```typescript
--8<-- "user-guide/sdk/agents/interventions/interventions_imports.ts:basic_usage_imports"

--8<-- "user-guide/sdk/agents/interventions/interventions.ts:basic_usage"
```
</Tab>
</Tabs>
...
```python
--8<-- "user-guide/sdk/agents/interventions/interventions.py:action_types"
```
</Tab>
<Tab label="TypeScript">

```typescript
--8<-- "user-guide/sdk/agents/interventions/interventions_imports.ts:action_types_imports"

--8<-- "user-guide/sdk/agents/interventions/interventions.ts:action_types"
```
</Tab>
</Tabs>
...
```python
--8<-- "user-guide/sdk/agents/interventions/interventions.py:short_circuiting"
```
</Tab>
<Tab label="TypeScript">

```typescript
--8<-- "user-guide/sdk/agents/interventions/interventions_imports.ts:short_circuiting_imports"

--8<-- "user-guide/sdk/agents/interventions/interventions.ts:short_circuiting"
```
</Tab>
</Tabs>
...
```python
--8<-- "user-guide/sdk/agents/interventions/interventions.py:error_handling"
```
</Tab>
<Tab label="TypeScript">

```typescript
--8<-- "user-guide/sdk/agents/interventions/interventions_imports.ts:error_handling_imports"

--8<-- "user-guide/sdk/agents/interventions/interventions.ts:error_handling"
```
</Tab>
</Tabs>
...
- **With `response`**: the value is passed directly to the `evaluate` function, so the agent never pauses.
...
```python
--8<-- "user-guide/sdk/agents/interventions/interventions.py:confirm"
```
</Tab>
<Tab label="TypeScript">
...
```typescript
--8<-- "user-guide/sdk/agents/interventions/interventions_imports.ts:confirm_imports"

--8<-- "user-guide/sdk/agents/interventions/interventions.ts:confirm"
```
...
Interventions build on the [hooks](../hooks.mdx) system: each lifecycle method registers a hook callback. The difference is in how they communicate with the framework.
