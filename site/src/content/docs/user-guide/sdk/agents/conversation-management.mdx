...
A conversation manager keeps your agent's context window within the model's token
limit as the conversation grows, trimming or summarizing older messages while
preserving the ones that still matter. It runs inside the agent loop, so context
management happens automatically as messages accumulate.

This page covers the built-in conversation managers and how to write your own. If
you want sensible defaults wired up for you rather than configuring a manager by
hand, start with [Manage the context window](../context-management); the managers
documented here are the mechanism underneath it.
...
```typescript
--8<-- "user-guide/sdk/agents/conversation-management_imports.ts:null_conversation_manager_imports"

--8<-- "user-guide/sdk/agents/conversation-management.ts:null_conversation_manager"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/agents/conversation-management_imports.ts:sliding_window_conversation_manager_imports"

--8<-- "user-guide/sdk/agents/conversation-management.ts:sliding_window_conversation_manager"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/agents/conversation-management_imports.ts:summarizing_conversation_manager_basic_imports"

--8<-- "user-guide/sdk/agents/conversation-management.ts:summarizing_conversation_manager_basic"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/agents/conversation-management_imports.ts:summarizing_conversation_manager_custom_imports"

--8<-- "user-guide/sdk/agents/conversation-management.ts:summarizing_conversation_manager_custom"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/agents/conversation-management_imports.ts:summarizing_conversation_manager_system_prompt_imports"

--8<-- "user-guide/sdk/agents/conversation-management.ts:summarizing_conversation_manager_system_prompt"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/agents/conversation-management_imports.ts:summarizing_conversation_manager_advanced_imports"

--8<-- "user-guide/sdk/agents/conversation-management.ts:summarizing_conversation_manager_advanced"
```
...
```typescript
--8<-- "user-guide/sdk/agents/conversation-management_imports.ts:pin_first_imports"

--8<-- "user-guide/sdk/agents/conversation-management.ts:pin_first"
```
...
```typescript
--8<-- "user-guide/sdk/agents/conversation-management_imports.ts:proactive_sliding_window_imports"

--8<-- "user-guide/sdk/agents/conversation-management.ts:proactive_sliding_window"
```

**With SummarizingConversationManager:**

```typescript
--8<-- "user-guide/sdk/agents/conversation-management_imports.ts:proactive_summarizing_imports"

--8<-- "user-guide/sdk/agents/conversation-management.ts:proactive_summarizing"
```
...
For details on how the SDK estimates tokens, resolves context
window limits, and computes utilization, see
[Context Estimation](../context-management/context-estimation).
...
```typescript
--8<-- "user-guide/sdk/agents/conversation-management_imports.ts:custom_conversation_manager_imports"

--8<-- "user-guide/sdk/agents/conversation-management.ts:custom_conversation_manager"
```

For proactive management alongside overflow recovery, override `initAgent`:

```typescript
--8<-- "user-guide/sdk/agents/conversation-management_imports.ts:custom_conversation_manager_proactive_imports"

--8<-- "user-guide/sdk/agents/conversation-management.ts:custom_conversation_manager_proactive"
```
