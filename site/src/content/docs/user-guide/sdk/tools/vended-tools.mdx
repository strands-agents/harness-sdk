...
sourceLinks:
  ...
  - path: strands-ts/src/vended-tools/mcp-router/mcp-router.ts
...
```typescript
--8<-- "user-guide/sdk/tools/vended-tools-imports.ts:mcp_router_import"

--8<-- "user-guide/sdk/tools/vended-tools.ts:mcp_router_example"
```
