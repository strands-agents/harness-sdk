...
description: "Auto and agentic context management modes with tuned defaults for most agents."
experimental: true
...
For full control over the strategy pipeline, see [Custom Strategies](./custom-strategies). For named shorthand configurations, see [Strategy Presets](./presets).

## Automatic context management

Pass <Syntax py='context_manager="auto"' ts='contextManager: "auto"' /> and the SDK manages context in the background with no model involvement:
...
```typescript
--8<-- "user-guide/sdk/context-management/built-in-modes_imports.ts:auto_imports"

--8<-- "user-guide/sdk/context-management/built-in-modes.ts:auto"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/context-management/built-in-modes_imports.ts:agentic_imports"

--8<-- "user-guide/sdk/context-management/built-in-modes.ts:agentic"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/context-management/built-in-modes_imports.ts:disabled_imports"

--8<-- "user-guide/sdk/context-management/built-in-modes.ts:disabled"
```
</Tab>
</Tabs>
