...
This guide covers deploying Python-based Strands agents using Docker for local and cloud development.
...
**Note**: This example uses OpenAI, but any supported model provider can be configured. See the [Strands documentation](https://strandsagents.com/latest/documentation/docs/user-guide/sdk/model-providers) for all supported model providers.
...
```python
--8<-- "user-guide/sdk/deploy/deploy_to_docker/imports.py:imports"
--8<-- "user-guide/sdk/deploy/deploy_to_docker/agent.py:agent"
```
