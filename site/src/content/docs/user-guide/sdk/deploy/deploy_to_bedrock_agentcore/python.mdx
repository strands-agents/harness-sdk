...
Follow one of the two approaches below, whichever fits your use case. You do not need both.
...
:::note[Next step: observability]
Your agent is deployed. You can also set up [Observability](#observability-enablement).
:::
