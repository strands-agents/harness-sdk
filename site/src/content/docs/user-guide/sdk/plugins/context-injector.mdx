...
This is the same injection mechanism that powers [memory context injection](../memory/managing-memory#context-injection). `ContextInjector` is the generic surface for any consumer.
...
```typescript
--8<-- "user-guide/sdk/plugins/context-injector_imports.ts:getting_started_imports"

--8<-- "user-guide/sdk/plugins/context-injector.ts:getting_started"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/plugins/context-injector_imports.ts:every_turn_imports"

--8<-- "user-guide/sdk/plugins/context-injector.ts:every_turn"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/plugins/context-injector_imports.ts:predicate_imports"

--8<-- "user-guide/sdk/plugins/context-injector.ts:predicate"
```
</Tab>
</Tabs>
...
- [Memory](../memory/managing-memory#context-injection) builds on this engine to inject retrieved knowledge before a model call.
