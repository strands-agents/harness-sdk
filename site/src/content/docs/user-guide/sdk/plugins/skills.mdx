...
Skills solve this by breaking instructions into self-contained packages. The agent sees a menu of available skills and loads the full instructions only when it needs them, the way a developer opens a reference manual only when working on a specific task.
...
```typescript
--8<-- "user-guide/sdk/plugins/skills_imports.ts:usage"

--8<-- "user-guide/sdk/plugins/skills.ts:usage"
```
</Tab>
</Tabs>
...
For filesystem-based skills, the vended `file_editor` and `shell` tools are the
...
```typescript
--8<-- "user-guide/sdk/plugins/skills_imports.ts:tools"

--8<-- "user-guide/sdk/plugins/skills.ts:tools"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/plugins/skills_imports.ts:programmatic"

--8<-- "user-guide/sdk/plugins/skills.ts:programmatic"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/plugins/skills_imports.ts:runtime"

--8<-- "user-guide/sdk/plugins/skills.ts:runtime"
```
</Tab>
</Tabs>
...
2. Use `file_editor` to review the output
...
| [Steering](/docs/user-guide/sdk/agents/interventions/steering/) | Dynamic, context-aware guidance and validation | More complex to set up |
...
- [Steering](/docs/user-guide/sdk/agents/interventions/steering/): Context-aware guidance for complex tasks
