...
description: "Write your own Strands plugin: attach it to an agent, register hooks and tools, manage state, and initialize asynchronously."
...
A plugin bundles hooks and tools into one reusable object you attach to an agent. It works against the low-level primitives the Agent class exposes: `model`, <Syntax py="system_prompt" ts="systemPrompt" />, `messages`, `tools`, and `hooks`. When the built-in plugins don't fit, you build and distribute your own. See [Get Featured](/docs/integrations/get-featured) to share your plugins with the community.
...
```typescript
--8<-- "user-guide/sdk/plugins/custom-plugins_imports.ts:using_plugins_imports"

--8<-- "user-guide/sdk/plugins/custom-plugins.ts:using_plugins"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/plugins/custom-plugins_imports.ts:basic_plugin_imports"

--8<-- "user-guide/sdk/plugins/custom-plugins.ts:basic_plugin"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/plugins/custom-plugins_imports.ts:hook_decorator_alternative_imports"

--8<-- "user-guide/sdk/plugins/custom-plugins.ts:hook_decorator_alternative"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/plugins/custom-plugins_imports.ts:manual_registration_imports"

--8<-- "user-guide/sdk/plugins/custom-plugins.ts:manual_registration"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/plugins/custom-plugins_imports.ts:state_management_imports"

--8<-- "user-guide/sdk/plugins/custom-plugins.ts:state_management"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/plugins/custom-plugins_imports.ts:async_initialization_imports"

--8<-- "user-guide/sdk/plugins/custom-plugins.ts:async_initialization"
```
</Tab>
</Tabs>
...
- [Agent State](../agents/state.mdx) - Persist and share plugin state
- [Get Featured](/docs/integrations/get-featured) - Share your plugins with the community
