...
```typescript
--8<-- "user-guide/sdk/plugins/goal-loop_imports.ts:getting_started"

--8<-- "user-guide/sdk/plugins/goal-loop.ts:getting_started"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/plugins/goal-loop_imports.ts:word_count_validator"

--8<-- "user-guide/sdk/plugins/goal-loop.ts:word_count_validator"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/plugins/goal-loop_imports.ts:async_validator"

--8<-- "user-guide/sdk/plugins/goal-loop.ts:async_validator"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/plugins/goal-loop.ts:inspecting_results"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/plugins/goal-loop.ts:preserve_context_false"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/plugins/goal-loop_imports.ts:judge_config"

--8<-- "user-guide/sdk/plugins/goal-loop.ts:judge_config"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/plugins/goal-loop.ts:custom_resume_prompt"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/plugins/goal-loop_imports.ts:custom_judge"

--8<-- "user-guide/sdk/plugins/goal-loop.ts:custom_judge"
```
</Tab>
</Tabs>
