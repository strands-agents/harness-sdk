...
[`MemoryManager`](../../user-guide/sdk/memory/overview.md) orchestrates one or
...
[Custom Stores](../../user-guide/sdk/memory/managing-memory.md#custom-stores) for the
contract.

The SDK ships reference stores like the
[Bedrock Knowledge Base store](../../user-guide/sdk/memory/bedrock-knowledge-base.md).
