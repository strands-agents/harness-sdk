...
[Interventions](../../user-guide/sdk/agents/interventions/) for the full concept and
built-in handlers.

The SDK ships reference handlers like
[Cedar Authorization](../../user-guide/sdk/agents/interventions/cedar-authorization.md),
[Steering](../../user-guide/sdk/agents/interventions/steering.md), and
[Human-in-the-Loop](../../user-guide/sdk/agents/interventions/human-in-the-loop.md).
