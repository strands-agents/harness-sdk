...
[`InMemoryStorage`](../../user-guide/sdk/storage.mdx#inmemorystorage),
[`LocalFileStorage`](../../user-guide/sdk/storage.mdx#localfilestorage),
and
[`S3Storage`](../../user-guide/sdk/storage.mdx#s3storage).
