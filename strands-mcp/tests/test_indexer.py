...
class TestSourceWeighting:
    @pytest.mark.parametrize("example_path", ["/docs/examples/python/agent/", "/examples/agent/"])
    def test_search_prioritizes_guides_and_examples_over_api_reference(self, example_path: str) -> None:
        ...
        example_doc = Doc(
            uri=f"https://strandsagents.com{example_path}",
            display_title="Agent",
            content="",
            index_title="Agent",
        )
        user_guide_doc = Doc(
            uri="https://strandsagents.com/docs/user-guide/sdk/agents/",
            display_title="Agent",
            content="",
            index_title="Agent",
        )
    ...
    def test_search_preserves_explicit_api_intent(self) -> None:
        ...
        user_guide_doc = Doc(
            uri="https://strandsagents.com/docs/user-guide/sdk/hooks/",
            display_title="Hooks",
            content="",
            index_title="hooks",
        )
